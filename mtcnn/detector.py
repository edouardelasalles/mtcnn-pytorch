...
def detect_faces(image, models, device, min_face_size=20.0, thresholds=[0.6, 0.7, 0.8], nms_thresholds=[0.7, 0.7, 0.7]):
    """
    Arguments:
    ...
    for s in scales:
        boxes = run_first_stage(image, pnet, s, thresholds[0], device)
